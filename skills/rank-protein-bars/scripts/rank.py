...
Identical logic to skills/rank-protein-powders/scripts/rank.py — the math is
the same; only the curated nutrition database differs. If a third domain
appears, extract this to a shared module.
